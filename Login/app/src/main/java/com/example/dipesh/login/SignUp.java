    ...
    public void onClick(View v)
    {
       ...
       /* switch (v.getId())
        ...
        else
        {
            ...
            database.execute("register", Name.getText().toString(), Address.getText().toString(), Phone.getText().toString(), Email.getText().toString(), Username.getText().toString(), Password.getText().toString());
